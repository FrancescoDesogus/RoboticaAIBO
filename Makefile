...
# Project:  Robotica.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -spec linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile Robotica.pro
#############################################################################
...
INCPATH       = -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64 -I. -I/home/francesco/QtCreatorProjects/Robotica\..\..\liburbi -I/usr/local/include/opencv -I/usr/include/qt5 -I/usr/include/qt5/QtQuick -I/usr/include/qt5/QtQml -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtNetwork -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I.
LINK          = g++
LFLAGS        = -m64
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 /home/francesco/QtCreatorProjects/Robotica//lib/liburbi.a -pthread -L/usr/local/lib -lopencv_core -lopencv_imgcodecs -lopencv_highgui -lopencv_imgproc -lQt5Quick -L/usr/lib/x86_64-linux-gnu -lQt5Qml -lQt5Widgets -lQt5Network -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = main.cpp \
		imagemanager.cpp \
		mapmanager.cpp \
		robotmanager.cpp moc_mapmanager.cpp \
		moc_robotmanager.cpp
OBJECTS       = main.o \
		imagemanager.o \
		mapmanager.o \
		robotmanager.o \
...
Makefile: Robotica.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile Robotica.pro
...
dist: 
	@test -d .tmp/Robotica1.0.0 || mkdir -p .tmp/Robotica1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Robotica1.0.0/ && $(COPY_FILE) --parents imagemanager.h mapmanager.h robotmanager.h .tmp/Robotica1.0.0/ && $(COPY_FILE) --parents main.cpp imagemanager.cpp mapmanager.cpp robotmanager.cpp .tmp/Robotica1.0.0/ && (cd `dirname .tmp/Robotica1.0.0` && $(TAR) Robotica1.0.0.tar Robotica1.0.0 && $(COMPRESS) Robotica1.0.0.tar) && $(MOVE) `dirname .tmp/Robotica1.0.0`/Robotica1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Robotica1.0.0
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_mapmanager.cpp moc_robotmanager.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mapmanager.cpp moc_robotmanager.cpp
moc_mapmanager.cpp: /usr/include/qt5/QtQuick/QQuickView \
...
moc_robotmanager.cpp: imagemanager.h \
		...
		lib/uabstractclient.h \
		robotmanager.h
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) $(INCPATH) -I/usr/include/c++/4.8 -I/usr/include/x86_64-linux-gnu/c++/4.8 -I/usr/include/c++/4.8/backward -I/usr/lib/gcc/x86_64-linux-gnu/4.8/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/4.8/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include robotmanager.h -o moc_robotmanager.cpp
...
moc_mapmanager.o: moc_mapmanager.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_mapmanager.o moc_mapmanager.cpp

moc_robotmanager.o: moc_robotmanager.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_robotmanager.o moc_robotmanager.cpp
